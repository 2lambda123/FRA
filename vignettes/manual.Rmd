...
abstract:
  R- package FRA is designed to perform fractional response analysis of single-cell responses as presented in the manuscript Nienałtowski et al. "Fractional response analysis reveals logarithmic cytokine responses in cellular populations".
...
```{r data_pdf3, fig.cap="Structure of an experimental dataset required for running FRA", ,echo=FALSE, fig.pos="h",out.height="9cm"}
# All defaults
...
```{r scrc_cytof_3, include=TRUE, eval=TRUE, cache=TRUE,fig.align="center" }
FRA::plotFRC(model = model) 
```
To obtain the cell-to-cell heterogeneity as a pie charts call:
```{r scrc_cytof_4, include=TRUE, eval=TRUE, cache=TRUE, fig.align="center" }
